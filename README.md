...
R package **mrcommons**, version **0.37.9.9001**
...
10.5281/zenodo.3822009 (URL: https://doi.org/10.5281/zenodo.3822009), R package version 0.37.9.9001, <URL:
...
@Manual{,
  ...
  year = {2021},
  note = {R package version 0.37.9.9001},
