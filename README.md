...
R package **mrcommons**, version **0.63.0**
...
E, von Jeetze P, Martinelli E, Schreyer F, Soergel B, Dietrich J (2021). _mrcommons: MadRat commons Input Data Library_. doi:
10.5281/zenodo.3822009 (URL: https://doi.org/10.5281/zenodo.3822009), R package version 0.63.0, <URL:
