...
downloadEDGAR6 <- function(subtype = "n2o") {
  ...
  baseUrl <- "https://cidportal.jrc.ec.europa.eu/ftp/jrc-opendata/EDGAR/datasets/"
  settings <- list(n2o = list(title = "EDGAR 6 N2O data inventories by country and emission source",
                              url = paste0(baseUrl, "v60_GHG/N2O/v60_GHG_N2O_1970_2018.zip"),
                              doi = "10.1038/s43016-021-00225-9",
                              version = "6.0"),
                   ch4 = list(title = "EDGAR 6 CH4 data inventories by country and emission source",
                              url = paste0(baseUrl, "v60_GHG/CH4/v60_GHG_CH4_1970_2018.zip"),
                              doi = "10.1038/s43016-021-00225-9",
                              version = "6.0"),
                   # short cycle CO2
                   co2_incl_short = list(title = paste0("EDGAR 6 CO2 (including short cycle emissions) data ",
                                                        "inventories by country and emission source"),
                                         url = paste0(baseUrl,
                                                      "v60_GHG/CO2_org_short-cycle_C/",
                                                      "v60_GHG_CO2_org_short-cycle_C_1970_2018.zip"),
                                         doi = "10.1038/s43016-021-00225-9",
                                         version = "6.0"),
                   # long cycle CO2
                   co2_excl_short = list(title = paste0("EDGAR 6 CO2 (excluding short cycle emisssions) data ",
                                                        "inventories by country and emission source"),
                                         url = paste0(baseUrl,
                                                      "v60_GHG/CO2_excl_short-cycle_org_C/",
                                                      "v60_GHG_CO2_excl_short-cycle_org_C_1970_2018.zip"),
                                         doi = "10.1038/s43016-021-00225-9",
                                         version = "6.0"),
                   bc = list(title = "EDGAR 5 BC data inventories by country and emission source",
                             url = paste0(baseUrl, "v50_AP/BC/v50_BC_1970_2015.zip"),
                             doi = "10.2760/687800",
                             version = "5.0"),
                   co = list(title = "EDGAR 5 CO data inventories by country and emission source",
                             url = paste0(baseUrl, "v50_AP/CO/v50_CO_1970_2015.zip"),
                             doi = "10.2760/687800",
                             version = "5.0"),
                   nh3 = list(title = "EDGAR 5 NH3 data inventories by country and emission source",
                              url = paste0(baseUrl, "v50_AP/NH3/v50_NH3_1970_2015.zip"),
                              doi = "10.2760/687800",
                              version = "5.0"),
                   nmvoc = list(title = "EDGAR 5 NMVOC data inventories by country and emission source",
                                url = paste0(baseUrl, "v50_AP/NMVOC/v50_NMVOC_1970_2015.zip"),
                                doi = "10.2760/687800",
                                version = "5.0"),
                   no2 = list(title = "EDGAR 5 NOx data inventories by country and emission source",
                              url = paste0(baseUrl, "v50_AP/NOx/v50_NOx_1970_2015.zip"),
                              doi = "10.2760/687800",
                              version = "5.0"),
                   oc = list(title = "EDGAR 5 OC data inventories by country and emission source",
                             url = paste0(baseUrl, "v50_AP/OC/v50_OC_1970_2015.zip"),
                             doi = "10.2760/687800",
                             version = "5.0"),
                   pm10 = list(title = "EDGAR 5 PM10 data inventories by country and emission source",
                               url = paste0(baseUrl, "v50_AP/PM10/v50_PM10_1970_2015.zip"),
                               doi = "10.2760/687800",
                               version = "5.0"),
                   pm25 = list(title = "EDGAR 5 PM25 data inventories by country and emission source",
                               url = paste0(baseUrl, "v50_AP/PM2.5/v50_PM2.5_1970_2015.zip"),
                               doi = "10.2760/687800",
                               version = "5.0"),
  ...
  if (meta$version == "6.0") {
    ...
    meta$reference <- bibentry("TechReport",
                               ...
                               year = "2019",
                               institution = "JRC",
                               url = paste0("http://publications.europa.eu/publication/manifestation_identifier/",
                                            "PUB_KJNA29849ENN"),
                               doi = "10.2760/687800")
  }
  ...
  return(list(url           = meta$url,
              ...
              # http://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/EDGAR/datasets/v60_GHG/copyright.txt
