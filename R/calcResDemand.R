...
calcResDemand <- function(cellular = FALSE, scenario = "dafault") {
  ...
  resCereals    <- mapping$kcr[mapping$kres == "resCereals"]
  resFibrous    <- mapping$kcr[mapping$kres == "resFibrous"]
  resNonfibrous <- mapping$kcr[mapping$kres == "resNonfibrous"]
