...
convertImageMacc <- function(x, subtype) {
  ...
  if (subtype == "PFC_tot") {
    ...
    names <- c("CH4 coal losses/leakages", "CH4 oil losses/leakages", "CH4 natural gas losses/leakages",
    ...
    w[, , "N2O Fertilizer"]             <- dimSums(luMagpie[, , c("n2ofertin.SSP2.rcp26", "n2ofertcr.SSP2.rcp26",
                                                                   "n2ofertsom.SSP2.rcp26")])
    w[, , "N2O Animal waste"]           <- dimSums(luMagpie[, , c("n2oanwstc.SSP2.rcp26", "n2oanwstm.SSP2.rcp26",
