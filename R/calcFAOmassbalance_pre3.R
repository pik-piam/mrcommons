...
calcFAOmassbalance_pre3 <- function(years = paste0("y", seq(1965, 2010, 5))) {
  ...
  .extract_good_from_flow <- function(object,
                                      good_in,              # e.g. "2536|Sugar cane"
                                      from,                 # e.g. "other_util"
                                      process,              # e.g. "distilling"
                                      extract,              # e.g. "X001|Ethanol"
                                      report_as,            # e.g. "ethanol1"
                                      extraction_quantity,  # e.g. 0.516006
                                      extraction_attribute, # e.g. "dm"
                                      residual,             # e.g. "distillingloss"
                                      prod_attributes) {
    ...
    attributes_to   <- prod_attributes[, , extract, drop = T] / prod_attributes[, , list(extract, extraction_attribute), drop = TRUE]
  ...
  # processing of cereals to brans and flour
  ...
  # processing of cereals to ethanol, distillers grain and distilling loss
  ...
  # processing of beercereals to alcohol1 and alcoholloss
  ...
  # processing of sugar cane and sugar beet to sugar1, molasses1 and refiningloss
  ...
  # extraction of oil and oilcake from palm/palmkernel
  ...
  # extraction of oil and oilcakes from oilcrops
