...
calcSOCLossShare <- function(subsystems = FALSE, rate = "change", ipcc = "guide2006") {
  ...
  kg2ipcc$koeppenGeiger <- tolower(kg2ipcc$koeppenGeiger)
  ...
  ipccClimate           <- toolAggregate(kgClimate, rel = kg2ipcc,
                                         from = "koeppenGeiger", to = climateClasses, dim = 3)
